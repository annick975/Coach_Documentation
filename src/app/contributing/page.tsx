    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-400">
          Learn how to contribute to the GitGuardian project
        </p>
      </div>
...
git remote add upstream https://github.com/gitguardian/gitguardian.git`}
              </CodeBlock>
            </div>
        ...
        <div className="bg-slate-900 p-6 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-slate-800 p-4 rounded-md">
              ...
              <p className="text-slate-400">
                Join our Discord server to chat with other contributors and the
                maintainers.
              </p>
              <div className="mt-3">
                <a
            ...
            <div className="bg-slate-800 p-4 rounded-md">
              ...
              <div className="mt-3">
                <a
                  href="https://github.com/gitguardian/gitguardian/issues/new?labels=question"
