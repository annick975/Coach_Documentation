    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-400">
          Overview of GitGuardian's web interface features and components
        </p>
      </div>
      ...
      <div className="space-y-6">
        <div className="bg-slate-900 p-6 rounded-lg">
          ...
          <p>
            The GitGuardian dashboard is designed for clarity and ease of use,
  ...
  <button className="mt-3 bg-emerald-600 hover:bg-emerald-700 px-4 py-2 rounded-md
    ...
    Apply Fix
        ...
        <div className="bg-slate-900 p-6 rounded-lg">
          ...
          <p className="mb-6">
            GitGuardian's frontend is designed with user experience as a
